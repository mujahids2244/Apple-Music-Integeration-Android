...
import com.arhamsoft.matchranker.databinding.ActivityBottomsheetPlayerBinding
...
class Bottomsheet_Player : AppCompatActivity(), PassThePositionOfPlayingSong {
    private var handler = Handler(Looper.getMainLooper())
    private var totalTime: Double = 0.0
    lateinit var runnable: Runnable
    private lateinit var mediaBrowserHelper: MediaBrowserHelperJava
    lateinit var binding: ActivityBottomsheetPlayerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBottomsheetPlayerBinding.inflate(layoutInflater)
...
//
//        rvAdapter = RVAdapter(this, songList,0, object : RVAdapter.OnItemClick {
...
//        )*/
//
//        totalTime = URLs.currentSong!!.duration
//        var total = createTimeLabel(totalTime)
...
//
//            onBackPressed()
//            overridePendingTransition(0, R.anim.slide_down2)
//            finish()
//        }
//
...
////        var sec = time / 1000 % 60
    ...
    private fun updatePosition() {
        ...
        binding.seekbar.progress = currentPosition.toInt()
        val elapsedTime = createTimeLabel(currentPosition.toDouble())
            binding.songPosition.text = elapsedTime
    }
        ...
        if (mediaController != null) {
            when (mediaController.playbackState!!.state) {
                ...
                PlaybackStateCompat.STATE_PAUSED -> {
                    binding.playSong.setImageResource(R.drawable.ic_notification_pause)
    ...
    override fun onDestroy() {
        Log.d("MainScreen@3445", "onDestory")
        RequestKeysAndCodes.upDateThePosition(position)
        super.onDestroy()
    }
