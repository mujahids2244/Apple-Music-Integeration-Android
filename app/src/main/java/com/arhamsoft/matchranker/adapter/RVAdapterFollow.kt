...
class RVAdapterFollow(
    var context: Context,
    private var sList: ArrayList<FollowModelDataList>,
    var check:Int,
    private var listenerClick: OnItemClick,

) : RecyclerView.Adapter<RVAdapterFollow.ViewHolder>() {
    ...
    fun addData(slist: ArrayList<FollowModelDataList>) {
        this.sList = slist
...
//        }
    ...
    class ViewHolder(val bind: CardViewFollowBinding) : RecyclerView.ViewHolder(bind.root) {
        fun onBind(model: FollowModelDataList, listener: OnItemClick, position: Int) {
    ...
    interface OnItemClick {
        ...
        fun onFollowClick(follow: FollowModelDataList,position: Int)
        fun onUnFollowClick(follow: FollowModelDataList,position: Int)
        fun onGotoProfile(follow: FollowModelDataList,position: Int)
        fun unblockUser(follow: FollowModelDataList,position: Int)
